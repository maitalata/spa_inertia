        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.name">{{
                        form.errors.name }}
                    </div>
                </div>
    
                <!-- Brand and Category on the same line -->
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.brand">{{
                        form.errors.brand }}
                    </div>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.category_id">{{
                        form.errors.category_id }}</div>
                </div>
    
                <!-- Price and Weight on the same line -->
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.price">{{
                        form.errors.price }}
                    </div>
                </div>
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.weight">{{
                        form.errors.weight
                        }}</div>
                </div>
                ...
                <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="mt-2 text-red-500 font-sm" v-if="form.errors.description">{{
